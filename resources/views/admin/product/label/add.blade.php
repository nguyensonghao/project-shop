...
@section('title', trans('admin.add_label'))
@section('title-content', trans('admin.add_label'))

@section('content')
	<form id="form-add-label" class="form-horizontal form-label-left input_mask" action="{{route('admin.label.add')}}" method="post" enctype="multipart/form-data">
